...
%     title('(c)', 'Units', 'normalized','FontWeight','bold','color', 'black', 'Position', z ,'FontSize', 16);
    ...
    plot(fshift1,amp1,'LineWidth',lineWidth);
...
%     title('(d)', 'Units', 'normalized', 'FontWeight','bold','color', 'black','Position',z ,'FontSize', 16);
    ...
    plot(fshift2,amp2,'LineWidth',lineWidth);
...
%     title('(e)', 'Units', 'normalized','FontWeight','bold','color', 'black', 'Position',z ,'FontSize', 16);
    ...
    plot(fshift3,amp3,'LineWidth',lineWidth);
...
view(0,90);
    ...
    grid on;
   axis tight; % 设置坐标紧凑型
%     title('(g)', 'Units', 'normalized','FontWeight','bold','color', 'white', 'Position', z ,'FontSize', 16);
    set(gca,'YTickLabel',10^-3*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 7
        return;
    end
...
view(0,90);
    ...
    grid on;
   axis tight; % 设置坐标紧凑型
%     title('(h)', 'Units', 'normalized', 'FontWeight','bold','color', 'white', 'Position', z ,'FontSize', 16);
    set(gca,'YTickLabel',10^-3*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 8
        return;
    end
...
view(0,90);
    ...
    grid on;
   axis tight; % 设置坐标紧凑型
%     title('(i)', 'Units', 'normalized', 'FontWeight','bold','color', 'white', 'Position', z ,'FontSize', 16);
    set(gca,'YTickLabel',10^-3*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 9
        return;
    end
