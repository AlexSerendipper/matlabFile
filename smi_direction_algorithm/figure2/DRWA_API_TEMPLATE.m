...
%     hold on;
%     scatter(loc_op0,top_op0','r','LineWidth',lineWidth);
...
%     loc_ov0 = N2T(loc_ov0,N,T);
    scatter(loc_ov0./fs,top_ov0,'g','LineWidth',lineWidth);
%     hold on;
%     scatter(loc_c,top_c);
    % 横纵坐标轴+图框的粗细、大小、线宽
    set(gca,'LineWidth',lineWidth,'FontName',fontName,'FontWeight',fontWeight,'FontSize',fontSize);
...
% 处理头和尾
tempDir(1:loc_v(1)) = tempDir(loc_v(1));
tempDir(loc_v(length(loc_v)):end) = tempDir(loc_v(length(loc_v))-1);

    plot(t,tempDir,'r','LineWidth',lineWidth);
    hold on;
...
%     axis tight; 
    ...
    plot(p_init,'LineWidth',lineWidth);
    hold on;
    scatter(loc_op2,top_op2,'p','filled','r','LineWidth',lineWidth);
    ...
    plot(p_init,'LineWidth',lineWidth);
    hold on;
    scatter(loc_op3,top_op3,'p','filled','r','LineWidth',lineWidth);
    ...
    plot(p_init,'LineWidth',lineWidth);
    hold on;
    scatter(loc_op4,top_op4,'p','filled','r','LineWidth',lineWidth);
