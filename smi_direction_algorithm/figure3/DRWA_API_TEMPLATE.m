...
% 处理头和尾
ttempDir(1:loc_v(1)) = ttempDir(loc_v(1));
ttempDir(loc_v(length(loc_v)):end) = ttempDir(loc_v(length(loc_v))-1);
    plot(t,ttempDir,'LineWidth',lineWidth);
...
%     axis tight; 
    ...
    hold on;
    plot(t,ones(1,N)*6.46*10^-9,'LineWidth',lineWidth);
