...
plot(phi04,phiF,'LineWidth',lineWidth,'LineStyle','--');
hold on;
legend('C=0.7','C=2.7','C=4.7','C=6.7');
...
%   axis([0 0.08 -20*10^-9 20*10^-9]);  % 设置具体横坐标和纵坐标的范围[x1,x2,y1,y2]
    title('(a)', 'Units', 'normalized', 'FontWeight','bold', 'color', 'black', 'Position', [0.066968397829264,0.885695754159701,0] ,'FontSize', 16);
