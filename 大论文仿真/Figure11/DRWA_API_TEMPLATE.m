...
%   set(gca,'xtick',[],'ytick',[],'xcolor','w','ycolor','w')  % 不显示x轴和y轴
    ...
    plot(t,acosp,'LineWidth',lineWidth);
...
%     axis tight; 
    ...
    plot(t,mul_op,'LineWidth',lineWidth);
    hold on;
    plot(t,add_op,'LineWidth',lineWidth);
    % 横纵坐标轴+图框的粗细、大小、线宽
    set(gca,'LineWidth',lineWidth,'FontName',fontName,'FontWeight',fontWeight,'FontSize',fontSize);
    xlabel('Time(ms)');
    ylabel('Amp.(a.u.)');
...
%     axis tight; 
    ...
    plot(t,phiF_reconstruct,'LineWidth',lineWidth);
...
%     axis tight; 
    ...
    hold on;
    plot(t,Lt_reconstruct,'LineWidth',lineWidth,'LineStyle','--');
