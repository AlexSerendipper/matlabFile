...
%     set(gca,'YTickLabel',10^6*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    ...
    load("D:\matlab save\self-mixing\smi_MODULATE\temp_experi.2_phiF_wrapped_times3.mat")
    ...
    load("D:\matlab save\self-mixing\smi_MODULATE\temp_experi.2_phiF_wrapped_times4.mat")
    plot(phiF_wrapped_init(100:13400)); grid on;
    ...
    hold on;
    load("D:\matlab save\self-mixing\smi_MODULATE\temp_experi.2_recon._times3.mat");
    plot(Lt_reconstruct_times3(100:13400),'Color','r'); grid on;  % 作图 + 网格
    hold on;
    load("D:\matlab save\self-mixing\smi_MODULATE\temp_experi.2_recon._times4.mat");
    ...
    load("D:\matlab save\self-mixing\smi_MODULATE\temp_experi.2_recon._times1.mat");
