...
% path =  'D:\matlab save\smi_实验信号\EOM\EOM_2K_3V10hz_HeNe.csv'; % 不太行
path =  'D:\matlab save\smi_实验信号\EOM\11v 40hz 4k 200k.csv';
M = 315000; N = 50000;  [t, p, fs] = MOVE_API_EXPERIMENT(M, N, path);  % 1 加载.csv文件，从M点处开始取N个点
...
arr = [31,369,2772,2839,2958,5379,7737,7836,10330,12800,12915];
arr1 = [369,2832,5379,7836,10330,12915];
