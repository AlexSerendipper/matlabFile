function DRWA_API_TEMPLATE_fig2(varargin)
    ...
    plot(t,phiF_wrapped_init,'LineWidth',lineWidth)
...
%     set(gca,'YTickLabel',10^-3*get(gca,'YTick'))
    ...
    hold on;
    plot(t,Lt_reconstruct_times1,'LineWidth',lineWidth); 
    ...
    plot(t,Lt,'LineWidth',lineWidth);
    hold on;
    plot(t,Lt_reconstruct_times2,'LineWidth',lineWidth);
    ...
    plot(t,Lt-Lt_reconstruct_times1,'LineWidth',lineWidth);
    ...
    plot(t,Lt-Lt_reconstruct_times2,'LineWidth',lineWidth)
    % 横纵坐标轴+图框的粗细、大小、线宽
    set(gca,'LineWidth',lineWidth,'FontName',fontName,'FontWeight',fontWeight,'FontSize',fontSize);
    xlabel('Time(ms)')
    ylabel('Error.(nm)')
