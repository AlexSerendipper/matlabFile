...
plot(diffp);
hold on;
[top_diffp_p,loc_diffp_p] = findpeaks(diffp,'minpeakheight',0, 'minpeakdistance',0);  % 拿到极值和索引值
[top_diffp_v,loc_diffp_v] = findpeaks(-diffp,'minpeakheight',0, 'minpeakdistance',0);
