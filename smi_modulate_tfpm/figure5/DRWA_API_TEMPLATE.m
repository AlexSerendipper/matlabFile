...
%     axis tight; 
    ...
    title('(a)', 'Units', 'normalized', 'Position', [0.05580301847852,0.467720378515262,0] ,'FontSize', 16);
    ...
    grid on;
    axis tight; 
    title('(b)', 'Units', 'normalized', 'Position', [0.064277594892701,0.849742850425374,0] ,'FontSize', 16);
    ...
    grid on;
%     axis tight; 
    title('(c)', 'Units', 'normalized', 'Position', [0.05580301847852,0.467720378515262,0] ,'FontSize', 16);
    set(gca,'YTickLabel')  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 3
        return;
    end
