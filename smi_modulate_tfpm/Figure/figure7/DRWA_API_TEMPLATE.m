function DRWA_API_TEMPLATE(varargin)
    ...
    %% 第1幅图
    axes('Position',[0.0614,0.825,x,y]);  axis tight;  % 设置图像位置 + 坐标紧凑型 
...
%     axis tight; 
    ...
    %% 第2幅图
    axes('Position',[0.527,0.825,x,y]);  axis tight; 
...
%     axis tight; 
    ...
    %% 第3幅图
    axes('Position',[0.061451041666667,0.29361505065123,0.399919028340081,0.455296671490591]);  axis tight;
    plot(1);
%     mesh(T,F,abs(TF));
%     view(0,90);
    % 横纵坐标轴+图框的粗细、大小、线宽
    ...
    %% 第4幅图
    axes('Position',[0.527,0.564,0.173,0.186]);  axis tight;  % 设置图像位置 + 坐标紧凑型 
    plot(1);
%     len = length(F);
%     TF1 = abs(TF1);
...
%     view(0,90);
    ...
    %% 第5幅图
    axes('Position',[0.527,0.3017,0.173,0.186]);  axis tight;  % 设置图像位置 + 坐标紧凑型 
    plot(1);
%     len = length(F);
%     TF2 = abs(TF2);
...
%     view(0,90);
    ...
    %% 第6幅图
    axes('Position',[0.7547,0.564,0.173,0.186]);  axis tight;
    plot(1);
%     len = length(F);
...
%     view(0,90);
    ...
    %% 第7幅图
    axes('Position',[0.7547,0.3017,0.173,0.186]);  axis tight;
    plot(1);
%     len = length(F);
%     TF_curb = abs(TF_curb);
...
%     view(0,90);
    ...
    %% 第8幅图
    axes('Position',[0.0614,0.0798,x,y]);  axis tight;
    plot(t,Lt,'LineWidth',lineWidth);
    hold on;
   ...
   %% 第9幅图
    axes('Position',[0.527,0.0798,x,y]); 
