function DRWA_API_TEMPLATE(varargin)
    ...
    grid on;
%     axis tight; 
    title('(a)', 'Units', 'normalized','FontWeight','bold', 'Position', [0.057536022005877,0.537328221652517,0] ,'FontSize', 16);
    ...
    grid on;
    axis tight; 
    title('(b)', 'Units', 'normalized','color','white','FontWeight','bold', 'Position', [0.055308985231165,0.877078075082261,0] ,'FontSize', 16);
    ...
    grid on;
    axis tight; 
    title('(c)', 'Units', 'normalized','color','white','FontWeight','bold', 'Position', [0.057536022005877,0.537328221652517,0] ,'FontSize', 16);
    set(gca,'YTickLabel',10^-3*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 3
        return;
    end
    ...
    grid on;
    axis tight; 
    title('(d)', 'Units', 'normalized','color','white','FontWeight','bold', 'Position',[0.057536022005877,0.537328221652517,0] ,'FontSize', 16);
    set(gca,'YTickLabel',10^-3*get(gca,'YTick'))  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 4
        return;
    end
    ...
    plot(t,p1,'LineWidth',lineWidth,'color','#4DBEEE');
    ...
    grid on;
%     axis tight; 
    title('(e)', 'Units', 'normalized','FontWeight','bold', 'Position',z ,'FontSize', 16);
    set(gca,'YTickLabel')  % 乘10^6，让图像的纵坐标显示的是微米量级
    if nargin - 3  == 5
        return;
    end
    ...
    plot(t,p2,'LineWidth',lineWidth,'color','#4DBEEE');
...
%     axis tight; 
    ...
    plot(t,Lt,'LineWidth',lineWidth,'color','red');
    hold on;
...
%     legend("原信号","重构信号");
    ...
    grid on;
%     axis tight; 
    title('(g)', 'Units', 'normalized','FontWeight','bold', 'Position', z ,'FontSize', 16);
    ...
    plot(t,Lt-Lt_reconstruct,'LineWidth',lineWidth,'color','#4DBEEE');
    legend("RMS=19nm");
    ...
    grid on;
%     axis tight; 
    title('(h)', 'Units', 'normalized','FontWeight','bold', 'Position', z ,'FontSize', 16);
